...
async def create_agent(
    ...
    """
    [DEPRECATED] Create a Personal Super Agent instance with intelligent model routing.
    
    DEPRECATION WARNING: This function loads ALL tools (Sabine + Dream Team) which is
    inefficient. Use run_sabine_agent() or run_task_agent() directly instead.
    ...
    """
    logger.warning(
        "DEPRECATION: create_agent() is deprecated. "
        "Use run_sabine_agent() or run_task_agent() directly instead. "
        "This function loads ALL tools which is inefficient."
    )
...
async def run_agent(
    ...
    logger.warning(
        f"DEPRECATION: run_agent() is deprecated. "
        f"Use run_sabine_agent() or run_task_agent() directly. "
